...
router.get('/', brandController.fetchBrands); // if the root directory of the brand is wanted to be reached with get, the fetchBrand function in the brandController will work
